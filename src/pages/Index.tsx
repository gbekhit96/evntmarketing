    ...
    <main className="text-cream">
      ...
      <footer style={{ backgroundColor: '#0A0707' }} className="border-t border-wine">
        <div className={`${W} py-10 md:py-12`}>
          <div className="grid grid-cols-1 md:grid-cols-2 md:items-center gap-8 md:gap-12 text-center md:text-left">
            <div>
              <span className="font-serif text-lg font-semibold tracking-tight text-cream">EVNT</span>
            ...
            <div className="flex flex-col items-center md:items-end gap-2">
              ...
              <a href="https://www.instagram.com/evntmarketing/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-cream/40 hover:text-cream transition-colors mt-2" aria-label="Instagram">
                <Instagram size={16} />
                <span className="font-sans text-[11px] tracking-[0.05em]">@evntmarketing</span>
              </a>
            </div>
          </div>
          <div className="max-w-md mx-auto border-t border-cream/10 mt-8 pt-4">
